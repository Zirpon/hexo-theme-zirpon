...
function loadHighlightNormalLink() {
  ...
  link.type = 'text/css';
  link.rel = 'stylesheet';
  link.href = 'https://champon.gitee.io/blog/css/highlight_normal.css';
  let head = document.getElementsByTagName('head')[0];
  head.appendChild(link);
}

function deleteHighlightNormalLink() {
  let link = document.querySelector('link[href="https://champon.gitee.io/blog/css/highlight_normal.css"]').remove();
}
